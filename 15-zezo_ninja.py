...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.frame_index = 0
        self.walk_frames = [
            pygame.image.load("images/zezo_walk_1.png").convert_alpha(),
            pygame.image.load("images/zezo_walk_2.png").convert_alpha()
        ]
        self.jump_frame = pygame.image.load("images/zezo_walk_2.png").convert_alpha()
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        bullet_y = PlayerGroup.sprite.rect.top + 20
        self.image = pygame.transform.scale_by(pygame.image.load("images/star.png"), 0.5)
...
scaled_player = pygame.transform.scale_by(pygame.image.load("images/zezo_dead.png").convert_alpha(), 3)
scaled_player_rect = scaled_player.get_rect(midbottom=(400, 350))
